...
CREATE TABLE `libro` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_al_libro_editore` (`editore_id`),
  CONSTRAINT `fk_al_libro_editore` FOREIGN KEY (`editore_id`) REFERENCES `editore` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-03-02 10:07:36
